...
int main() {
	...
	Object *node;
	Exsym *tmp;
	funcPtr fPtr[] = { cmdHelp, cmdDir, cmdQuit, cmdHistory, cmdDump, cmdEdit, cmdFill, cmdReset, cmdOpcode, cmdOpcodelist, cmdAssemble, cmdType, cmdSymbol, cmdProgaddr, cmdLoader, cmdRun, cmdBp}; // function pointer to reduce the code
